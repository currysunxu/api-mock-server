...
module.exports = {
  "/omni/apigateway/api/v1/customer": "/accounts",
  ...
  "/omni/apigateway/api/v1/account/authenticate?loginName=:id&*": "/staffs/:id",
  "/omni/apigateway/api/v1/user/:id/profile": "profiles/:id",
  "/omni/apigateway/api/v1/teacher/:id/GetSessionsofDateandSchoolCode": "teachers/:id"
}
